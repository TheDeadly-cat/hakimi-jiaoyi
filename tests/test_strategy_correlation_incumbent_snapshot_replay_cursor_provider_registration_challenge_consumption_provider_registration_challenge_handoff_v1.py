...
class ChallengeConsumptionProviderRegistrationChallengeHandoffV1Tests(
    unittest.TestCase
):
    def setUp(self) -> None:
        ...
        self.registration_bundle = self._build_registration_bundle(
    ...
    def evaluate_handoff(
        self,
        registration_bundle: dict[str, object] | None = None,
        challenge_evidence=None,
        **overrides,
    ):
        bundle = self.registration_bundle if registration_bundle is None else registration_bundle
        kwargs = {
    ...
    def test_challenge_binds_exact_provider_nonce_and_declared_window(self) -> None:
        rebuilt = (
            challenge.build_challenge_consumption_provider_registration_challenge_v1(
                self.provider_preregistration,
                self.authority_preregistration,
    ...
    def test_independently_valid_wrong_challenge_hash_fails_handoff(self) -> None:
        alternate = self._build_registration_bundle(
    ...
    def test_independently_valid_wrong_nonce_fails_handoff(self) -> None:
        alternate = self._build_registration_bundle(
            self.signed_challenge["signed_challenge_hash"],
    ...
    def test_wrong_authority_key_self_signature_fails_preregistered_binding(self) -> None:
    ...
    def test_tampered_challenge_signature_is_rejected(self) -> None:
        tampered_signature = (
    ...
    def test_schema_alias_extra_field_and_preregistration_drift_fail_closed(self) -> None:
    ...
    def test_handoff_verifier_rebuilds_and_rejects_evidence_mutation(self) -> None:
        evidence = self.evaluate_handoff()
    ...
    def test_evidence_redacts_material_and_builders_do_not_mutate_inputs(self) -> None:
    ...
    def test_production_modules_have_no_private_key_io_clock_provider_or_runtime(self) -> None:
