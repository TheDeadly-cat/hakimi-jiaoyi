...
| 本机开发候选 | 从 `ed19d1172767f57418040bb167b2780caf5e7edb` 开始；完成既存账本归因、原件差异核查，准备公告字段与C/D规约，增加离线故障定位。候选身份与验证另行记录，不能引用旧main CI代替 |
...
| 财报内容 C/D | 十份官方公告已整理为待人工核准候选；固定C/D规约与离线规则测试就绪。人工核准及新经济研究仍未完成，不生成未经核准的方向信号或缺少一致预期的“超预期”字段 |
