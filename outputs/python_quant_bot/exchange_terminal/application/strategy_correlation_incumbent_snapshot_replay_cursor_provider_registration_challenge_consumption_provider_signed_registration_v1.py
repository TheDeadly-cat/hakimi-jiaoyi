"""Synthetic Ed25519 key-control proof for the ADR0391 provider key."""
...
REGISTRATION_CLAIM_SCHEMA_VERSION = (
    "incumbent-snapshot-replay-cursor-provider-registration-challenge-consumption-provider-registration-claim-v1"
)
SIGNED_REGISTRATION_SCHEMA_VERSION = (
    "incumbent-snapshot-replay-cursor-provider-registration-challenge-consumption-provider-signed-registration-v1"
)
VERIFICATION_EVIDENCE_SCHEMA_VERSION = (
    "incumbent-snapshot-replay-cursor-provider-registration-challenge-consumption-provider-signed-registration-verification-evidence-v1"
)
STATIC_FINGERPRINT = (
    "20260824-registration-challenge-consumption-provider-signed-registration-v1-synthetic-lock-1"
)
...
SIGNATURE_DOMAIN = (
    "hakimi.strategy-correlation.replay-cursor.challenge-consumption-provider-registration.v1"
)
...
class ChallengeConsumptionProviderSignedRegistrationError(ValueError):
    pass


def _require_hash(value: Any, label: str) -> str:
    if type(value) is not str or _HASH.fullmatch(value) is None:
        raise ChallengeConsumptionProviderSignedRegistrationError(
...
def _exact_preregistration(document: Any, kwargs: Any) -> dict[str, Any]:
    ...
    try:
        expected = preregistration.build_challenge_consumption_provider_preregistration_v1(
            **dict(kwargs)
        )
...
def build_challenge_consumption_provider_registration_claim_v1(
    ...
    *,
    ...
    document = {
        ...
        "status": "BLOCKED",
        "decision": (
            "CONSUMPTION_PROVIDER_REGISTRATION_CLAIM_UNSIGNED_CHALLENGE_"
...
def verify_challenge_consumption_provider_registration_claim_v1(
    document: Any,
    preregistration_document: Any,
    *,
    ...
    **build_kwargs: Any,
    ...
    try:
        expected = build_challenge_consumption_provider_registration_claim_v1(
    ...
    except (TypeError, ChallengeConsumptionProviderSignedRegistrationError):
        return False


def build_signed_challenge_consumption_provider_registration_v1(
    claim_document: Any,
    preregistration_document: Any,
    *,
...
def evaluate_signed_challenge_consumption_provider_registration_v1(
    ...
    **claim_build_kwargs: Any,
    ...
    try:
        expected_claim = build_challenge_consumption_provider_registration_claim_v1(
            preregistration_document, **claim_build_kwargs
        )
        claim_hash = _require_hash(expected_claim_hash, "expected_claim_hash")
        ...
        try:
            ...
            cryptographic_signature_verified = False
        expected_signed = build_signed_challenge_consumption_provider_registration_v1(
            claim_document,
            preregistration_document,
            public_key_spki_base64=public_key_spki_base64,
            signature_base64=signature_base64,
    ...
    except (KeyError, TypeError, ValueError, ChallengeConsumptionProviderSignedRegistrationError):
        pass
...
def verify_signed_challenge_consumption_provider_registration_evidence_v1(
    ...
    **evaluation_kwargs: Any,
    ...
    try:
        expected = evaluate_signed_challenge_consumption_provider_registration_v1(
...
__all__ = [
    ...
    "SIGNED_REGISTRATION_SCHEMA_VERSION",
    "VERIFICATION_EVIDENCE_SCHEMA_VERSION",
    "ChallengeConsumptionProviderSignedRegistrationError",
    "build_challenge_consumption_provider_registration_claim_v1",
    "build_signed_challenge_consumption_provider_registration_v1",
    "evaluate_signed_challenge_consumption_provider_registration_v1",
    "verify_challenge_consumption_provider_registration_claim_v1",
    "verify_signed_challenge_consumption_provider_registration_evidence_v1",
]
