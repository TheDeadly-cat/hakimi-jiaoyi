...
from exchange_terminal.application.strategy_correlation_incumbent_snapshot_replay_cursor_provider_registration_challenge_consumption_provider_preregistration_v1 import (
    PREREGISTRATION_SCHEMA_VERSION,
    build_challenge_consumption_provider_preregistration_v1,
)
from exchange_terminal.application.strategy_correlation_incumbent_snapshot_replay_cursor_provider_registration_challenge_consumption_provider_signed_registration_v1 import (
...
CHALLENGE_AUTHORITY_PREREGISTRATION_SCHEMA_VERSION = (
    "incumbent-snapshot-replay-cursor-provider-registration-challenge-consumption-provider-registration-challenge-authority-preregistration-v1"
)
REGISTRATION_CHALLENGE_SCHEMA_VERSION = (
    "incumbent-snapshot-replay-cursor-provider-registration-challenge-consumption-provider-registration-challenge-v1"
)
SIGNED_REGISTRATION_CHALLENGE_SCHEMA_VERSION = (
    "incumbent-snapshot-replay-cursor-provider-registration-challenge-consumption-provider-signed-registration-challenge-v1"
)
VERIFICATION_EVIDENCE_SCHEMA_VERSION = (
    "incumbent-snapshot-replay-cursor-provider-registration-challenge-consumption-provider-registration-challenge-signed-source-verification-evidence-v1"
)
STATIC_FINGERPRINT = (
    "20260824-challenge-consumption-provider-registration-challenge-signed-source-v1-synthetic-lock-1"
)
...
PROVIDER_SIGNED_REGISTRATION_IMPLEMENTATION_SHA256 = (
    "64cdf02d9249088dd917ae935b3ef17c4c84d412bef1d1dafced58d8601bb73b"
)
...
SIGNATURE_DOMAIN = (
    "hakimi.strategy-correlation.replay-cursor.challenge-consumption-provider.registration-challenge-source.v1"
)
SIGNATURE_MESSAGE_FORMAT = "RAW_SHA256_DIGEST_BYTES_V1"
CHALLENGE_PURPOSE = "CHALLENGE_CONSUMPTION_PROVIDER_REGISTRATION_KEY_POSSESSION_V1"
...
class ChallengeConsumptionProviderRegistrationChallengeSourceError(ValueError):
    pass


def _require_hash(value: Any, label: str) -> str:
    if type(value) is not str or _HASH.fullmatch(value) is None:
        raise ChallengeConsumptionProviderRegistrationChallengeSourceError(
...
def build_challenge_consumption_provider_registration_challenge_authority_preregistration_v1(
    *,
...
def verify_challenge_consumption_provider_registration_challenge_authority_preregistration_v1(
    document: Any,
    **kwargs: Any,
) -> bool:
    try:
        return document == build_challenge_consumption_provider_registration_challenge_authority_preregistration_v1(
            **kwargs
        )
    except (TypeError, ChallengeConsumptionProviderRegistrationChallengeSourceError):
        return False
...
def _authority_preregistration_exact(
    ...
    expected = build_challenge_consumption_provider_registration_challenge_authority_preregistration_v1(
        **clean
    )
    if document != expected:
        raise ChallengeConsumptionProviderRegistrationChallengeSourceError(
...
def build_challenge_consumption_provider_registration_challenge_v1(
...
def verify_challenge_consumption_provider_registration_challenge_v1(
    document: Any,
    provider_preregistration_document: Any,
    challenge_authority_preregistration_document: Any,
    *,
    ...
    **build_kwargs: Any,
    ...
    try:
        expected = build_challenge_consumption_provider_registration_challenge_v1(
...
def build_signed_challenge_consumption_provider_registration_challenge_v1(
...
def evaluate_signed_challenge_consumption_provider_registration_challenge_v1(
    ...
    **challenge_build_kwargs: Any,
    ...
    try:
        expected_challenge = build_challenge_consumption_provider_registration_challenge_v1(
            provider_preregistration_document,
            challenge_authority_preregistration_document,
            **challenge_build_kwargs,
        )
        ...
        try:
            ...
            cryptographic_signature_verified = False
        expected_signed = build_signed_challenge_consumption_provider_registration_challenge_v1(
            challenge_document,
            provider_preregistration_document,
            challenge_authority_preregistration_document,
            public_key_spki_base64=public_key_spki_base64,
        ...
        TypeError,
        ValueError,
        ChallengeConsumptionProviderRegistrationChallengeSourceError,
    ):
        pass
...
def verify_signed_challenge_consumption_provider_registration_challenge_evidence_v1(
    ...
    **evaluation_kwargs: Any,
    ...
    try:
        expected = evaluate_signed_challenge_consumption_provider_registration_challenge_v1(
...
__all__ = [
    ...
    "VERIFICATION_EVIDENCE_SCHEMA_VERSION",
    "ChallengeConsumptionProviderRegistrationChallengeSourceError",
    "build_challenge_consumption_provider_registration_challenge_authority_preregistration_v1",
    "verify_challenge_consumption_provider_registration_challenge_authority_preregistration_v1",
    "build_challenge_consumption_provider_registration_challenge_v1",
    "verify_challenge_consumption_provider_registration_challenge_v1",
    "build_signed_challenge_consumption_provider_registration_challenge_v1",
    "evaluate_signed_challenge_consumption_provider_registration_challenge_v1",
    "verify_signed_challenge_consumption_provider_registration_challenge_evidence_v1",
]
