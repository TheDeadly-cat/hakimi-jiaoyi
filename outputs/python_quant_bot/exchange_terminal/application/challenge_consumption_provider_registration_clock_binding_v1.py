"""Bind ADR0393 dual-signature evidence to signed clock observations."""
...
from exchange_terminal.application import (
    challenge_consumption_provider_registration_handoff_v1 as handoff_contract,
)
...
CLOCK_BINDING_EVIDENCE_SCHEMA_VERSION = (
    "challenge-consumption-provider-registration-clock-binding-evidence-v1"
)
STATIC_FINGERPRINT = (
    "20260824-challenge-consumption-provider-registration-clock-binding-"
    "v1-synthetic-lock-1"
)
CHALLENGE_SOURCE_IMPLEMENTATION_SHA256 = (
    "3eb90909dffe275053048743f7ad5e9567df7fc590b5040d0ebb214fbc16e1ca"
)
HANDOFF_IMPLEMENTATION_SHA256 = (
    "593eb672b93823f1b6d859577758b6040656b65e000b3736fea33297a0a73ab1"
)
...
class ChallengeConsumptionProviderRegistrationClockBindingError(ValueError):
    pass
...
def _copy_kwargs(value: Any, label: str) -> dict[str, Any]:
    if type(value) is not dict:
        raise ChallengeConsumptionProviderRegistrationClockBindingError(
...
def evaluate_challenge_consumption_provider_registration_clock_binding_v1(
    ...
    *,
    ...
    try:
        ...
        facts["handoff_evidence_exact"] = (
            handoff_contract.verify_challenge_consumption_provider_registration_handoff_v1(
                handoff_evidence,
                challenge_evidence,
...
def verify_challenge_consumption_provider_registration_clock_binding_v1(
    ...
    **kwargs: Any,
    ...
    try:
        expected = (
            evaluate_challenge_consumption_provider_registration_clock_binding_v1(
                *args, **kwargs
            )
        )
        return (
...
__all__ = [
    "CLOCK_BINDING_EVIDENCE_SCHEMA_VERSION",
    "ChallengeConsumptionProviderRegistrationClockBindingError",
    "evaluate_challenge_consumption_provider_registration_clock_binding_v1",
    "verify_challenge_consumption_provider_registration_clock_binding_v1",
]
