"""Exact ADR0399 dual-signature handoff with no runtime authority."""
...
from exchange_terminal.application import (
    genesis_replay_reservation_provider_registration_challenge_signed_source_v1 as challenge_source,
)
from exchange_terminal.application import (
    challenge_consumption_provider_genesis_replay_reservation_signed_registration_v1 as provider_registration,
)
...
STATIC_FINGERPRINT = (
    "20260824-genesis-replay-reservation-provider-registration-challenge-"
...
class GenesisReplayReservationProviderRegistrationHandoffError(ValueError):
    pass


def _require_hash(value: Any, label: str) -> str:
    if type(value) is not str or _HASH.fullmatch(value) is None:
        raise GenesisReplayReservationProviderRegistrationHandoffError(
...
def evaluate_genesis_replay_reservation_provider_registration_handoff_v1(
    ...
    *,
    ...
    try:
        ...
        expected_challenge_evidence = (
            challenge_source.evaluate_signed_genesis_replay_reservation_provider_registration_challenge_v1(
        ...
        expected_provider_evidence = (
            provider_registration.evaluate_signed_genesis_replay_reservation_provider_registration_v1(
...
def verify_genesis_replay_reservation_provider_registration_handoff_v1(
    ...
    **evaluation_kwargs: Any,
    ...
    try:
        expected = evaluate_genesis_replay_reservation_provider_registration_handoff_v1(
    ...
    except (TypeError, GenesisReplayReservationProviderRegistrationHandoffError):
        return False
...
__all__ = [
    ...
    "HANDOFF_EVIDENCE_SCHEMA_VERSION",
    "PROVIDER_SIGNED_REGISTRATION_IMPLEMENTATION_SHA256",
    "GenesisReplayReservationProviderRegistrationHandoffError",
    "evaluate_genesis_replay_reservation_provider_registration_handoff_v1",
    "verify_genesis_replay_reservation_provider_registration_handoff_v1",
]
