"""Exact ADR0393 dual-signature handoff with no runtime authority."""
...
class ChallengeConsumptionProviderRegistrationHandoffError(ValueError):
    pass


def _require_hash(value: Any, label: str) -> str:
    if type(value) is not str or _HASH.fullmatch(value) is None:
        raise ChallengeConsumptionProviderRegistrationHandoffError(
...
def evaluate_challenge_consumption_provider_registration_handoff_v1(
...
def verify_challenge_consumption_provider_registration_handoff_v1(
    ...
    **evaluation_kwargs: Any,
    ...
    try:
        expected = evaluate_challenge_consumption_provider_registration_handoff_v1(
    ...
    except (TypeError, ChallengeConsumptionProviderRegistrationHandoffError):
        return False
...
__all__ = [
    ...
    "HANDOFF_EVIDENCE_SCHEMA_VERSION",
    "PROVIDER_SIGNED_REGISTRATION_IMPLEMENTATION_SHA256",
    "ChallengeConsumptionProviderRegistrationHandoffError",
    "evaluate_challenge_consumption_provider_registration_handoff_v1",
    "verify_challenge_consumption_provider_registration_handoff_v1",
]
