...
from exchange_terminal.application.strategy_correlation_incumbent_snapshot_replay_cursor_provider_signed_registration_v1 import (
...
CHALLENGE_AUTHORITY_PREREGISTRATION_SCHEMA_VERSION = (
    "incumbent-snapshot-replay-cursor-provider-registration-challenge-authority-preregistration-v1"
)
REGISTRATION_CHALLENGE_SCHEMA_VERSION = (
    "incumbent-snapshot-replay-cursor-provider-registration-challenge-v1"
)
SIGNED_REGISTRATION_CHALLENGE_SCHEMA_VERSION = (
    "incumbent-snapshot-replay-cursor-provider-signed-registration-challenge-v1"
)
VERIFICATION_EVIDENCE_SCHEMA_VERSION = (
    "incumbent-snapshot-replay-cursor-provider-registration-challenge-signed-source-verification-evidence-v1"
)
STATIC_FINGERPRINT = (
    "20260824-replay-cursor-provider-registration-challenge-signed-source-v1-synthetic-lock-1"
)
...
PROVIDER_SIGNED_REGISTRATION_IMPLEMENTATION_SHA256 = (
    "c83f9f06cdd60ff28021664699d486e86fc5e4881b45d8899375a7a76c4d4950"
)
...
SIGNATURE_DOMAIN = (
    "hakimi.strategy-correlation.replay-cursor.provider-registration-challenge-source.v1"
)
SIGNATURE_MESSAGE_FORMAT = "RAW_SHA256_DIGEST_BYTES_V1"
CHALLENGE_PURPOSE = "REPLAY_CURSOR_PROVIDER_REGISTRATION_KEY_POSSESSION_V1"
...
class ReplayCursorProviderRegistrationChallengeContractError(ValueError):
    pass


def _require_hash(value: Any, label: str) -> str:
    if type(value) is not str or _HASH.fullmatch(value) is None:
        raise ReplayCursorProviderRegistrationChallengeContractError(
...
def _provider_preregistration_exact(
    ...
    try:
        expected = build_replay_cursor_provider_preregistration_v1(
...
def build_replay_cursor_provider_registration_challenge_authority_preregistration_v1(
    *,
...
def verify_replay_cursor_provider_registration_challenge_authority_preregistration_v1(
    document: Any,
    **kwargs: Any,
) -> bool:
    try:
        return document == build_replay_cursor_provider_registration_challenge_authority_preregistration_v1(
            **kwargs
        )
    except (TypeError, ReplayCursorProviderRegistrationChallengeContractError):
        return False
...
def _authority_preregistration_exact(
    ...
    expected = build_replay_cursor_provider_registration_challenge_authority_preregistration_v1(
        **clean
    )
    if document != expected:
        raise ReplayCursorProviderRegistrationChallengeContractError(
...
def build_replay_cursor_provider_registration_challenge_v1(
...
def verify_replay_cursor_provider_registration_challenge_v1(
    document: Any,
    provider_preregistration_document: Any,
    challenge_authority_preregistration_document: Any,
    *,
    ...
    **build_kwargs: Any,
    ...
    try:
        expected = build_replay_cursor_provider_registration_challenge_v1(
...
def build_signed_replay_cursor_provider_registration_challenge_v1(
...
def evaluate_signed_replay_cursor_provider_registration_challenge_v1(
    ...
    **challenge_build_kwargs: Any,
    ...
    try:
        expected_challenge = build_replay_cursor_provider_registration_challenge_v1(
            provider_preregistration_document,
            challenge_authority_preregistration_document,
            **challenge_build_kwargs,
        )
        ...
        try:
            ...
            cryptographic_signature_verified = False
        expected_signed = build_signed_replay_cursor_provider_registration_challenge_v1(
            challenge_document,
            provider_preregistration_document,
            challenge_authority_preregistration_document,
            public_key_spki_base64=public_key_spki_base64,
        ...
        TypeError,
        ValueError,
        ReplayCursorProviderRegistrationChallengeContractError,
    ):
        pass
...
def verify_signed_replay_cursor_provider_registration_challenge_evidence_v1(
    ...
    **evaluation_kwargs: Any,
    ...
    try:
        expected = evaluate_signed_replay_cursor_provider_registration_challenge_v1(
...
__all__ = [
    ...
    "VERIFICATION_EVIDENCE_SCHEMA_VERSION",
    "ReplayCursorProviderRegistrationChallengeContractError",
    "build_replay_cursor_provider_registration_challenge_authority_preregistration_v1",
    "verify_replay_cursor_provider_registration_challenge_authority_preregistration_v1",
    "build_replay_cursor_provider_registration_challenge_v1",
    "verify_replay_cursor_provider_registration_challenge_v1",
    "build_signed_replay_cursor_provider_registration_challenge_v1",
    "evaluate_signed_replay_cursor_provider_registration_challenge_v1",
    "verify_signed_replay_cursor_provider_registration_challenge_evidence_v1",
]
