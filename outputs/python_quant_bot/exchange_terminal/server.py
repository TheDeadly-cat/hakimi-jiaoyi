...
try:
    ...
    from services.http_contract import RETIRED_MANAGEMENT_PATHS, MUTATION_PATHS, POST_API_PATHS, READABLE_MUTATION_PATHS, allowed_web_origin, payload_to_query, read_only_get_mutation_requested, trusted_refresh_get_allowed
    ...
    from exchange_terminal.services.http_contract import RETIRED_MANAGEMENT_PATHS, MUTATION_PATHS, POST_API_PATHS, READABLE_MUTATION_PATHS, allowed_web_origin, payload_to_query, read_only_get_mutation_requested, trusted_refresh_get_allowed
