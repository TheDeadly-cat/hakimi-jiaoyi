(function (root, factory) {
  ...
  var card = typeof module === "object" && module.exports
    ? require("./evidence_portfolio_risk_stratified_multi_window_card_v8.js")
    : root.HakimiPortfolioRiskStratifiedMultiWindowCardV8;
  var api = factory(strictCanonical, card);
  if (typeof module === "object" && module.exports) module.exports = api;
  if (root) root.HakimiPortfolioRiskStratifiedMultiWindowConsumerFixtureV8 = api;
})(typeof globalThis !== "undefined" ? globalThis : this, function (strictCanonical, card) {
  "use strict";
  if (!strictCanonical || !card) throw new Error("Strict canonical and card-v8 are required");

  var SCHEMA_VERSION = "portfolio-risk-stratified-multi-window-consumer-fixture-v8";
  var STATIC_FINGERPRINT =
    "20260823-stratified-multi-window-consumer-v8-unmounted-lock-1";
  var STYLESHEET_ASSET = "evidence_portfolio_risk_stratified_multi_window_card_v8.css";
  ...
  function buildPortfolioRiskStratifiedMultiWindowConsumerFixtureV8(response) {
    var contractVerified = card.verifyStratifiedMultiWindowCandidateResponseV8(response) === true;
    var view = card.buildPortfolioRiskStratifiedMultiWindowViewModelV8(response);
    ...
    var descriptor = {
      ...
      status: "BLOCK",
      decision: known
        ? "KNOWN_BLOCKED_CANDIDATE_V8_RENDER_DESCRIPTOR_ONLY"
        : "UNKNOWN_CANDIDATE_V8_RENDER_DESCRIPTOR_FAIL_CLOSED",
      source: {
      ...
      presentation: {
        ...
        tone: view.tone,
        view_model: view,
        markup: card.renderPortfolioRiskStratifiedMultiWindowCardV8(response),
      ...
      facts: {
        response_v8_accepted: known,
        multi_window_summary_visible: known && view.window !== null,
        local_block_visible: known && view.status_label.indexOf("LOCAL BLOCK") === 0,
  ...
  function verifyPortfolioRiskStratifiedMultiWindowConsumerFixtureV8(descriptor, response) {
    if (!strictCanonical.verifySealedDocument(descriptor, "descriptor_hash")) return false;
    var expected = buildPortfolioRiskStratifiedMultiWindowConsumerFixtureV8(response);
  ...
  return Object.freeze({
    ...
    buildPortfolioRiskStratifiedMultiWindowConsumerFixtureV8:
      buildPortfolioRiskStratifiedMultiWindowConsumerFixtureV8,
    verifyPortfolioRiskStratifiedMultiWindowConsumerFixtureV8:
      verifyPortfolioRiskStratifiedMultiWindowConsumerFixtureV8,
  });
});
