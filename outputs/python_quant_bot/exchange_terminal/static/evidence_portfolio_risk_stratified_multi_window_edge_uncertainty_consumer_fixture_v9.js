(function (root, factory) {
  ...
  var card = typeof module === "object" && module.exports
    ? require("./evidence_portfolio_risk_stratified_multi_window_edge_uncertainty_card_v9.js")
    : root.HakimiPortfolioRiskStratifiedMultiWindowEdgeUncertaintyCardV9;
  var api = factory(strictCanonical, card);
  if (typeof module === "object" && module.exports) module.exports = api;
  if (root) root.HakimiPortfolioRiskStratifiedMultiWindowEdgeUncertaintyConsumerFixtureV9 = api;
})(typeof globalThis !== "undefined" ? globalThis : this, function (strictCanonical, card) {
  "use strict";
  if (!strictCanonical || !card) throw new Error("Strict canonical and card-v9 are required");

  var SCHEMA_VERSION =
    "portfolio-risk-stratified-multi-window-edge-uncertainty-consumer-fixture-v9";
  var STATIC_FINGERPRINT =
    "20260823-stratified-multi-window-edge-uncertainty-consumer-v9-" +
    "unmounted-lock-1";
  ...
  function buildPortfolioRiskStratifiedMultiWindowEdgeUncertaintyConsumerFixtureV9(
    response
  ) {
    var contractVerified =
      card.verifyStratifiedMultiWindowEdgeUncertaintyCandidateResponseV9(response) === true;
    var view =
      card.buildPortfolioRiskStratifiedMultiWindowEdgeUncertaintyViewModelV9(response);
    ...
    var descriptor = {
      ...
      status: "BLOCK",
      decision: known
        ? "KNOWN_BLOCKED_CANDIDATE_V9_RENDER_DESCRIPTOR_ONLY"
        : "UNKNOWN_CANDIDATE_V9_RENDER_DESCRIPTOR_FAIL_CLOSED",
      source: {
      ...
      presentation: {
        ...
        tone: view.tone,
        view_model: view,
        markup: card.renderPortfolioRiskStratifiedMultiWindowEdgeUncertaintyCardV9(
          response
        ),
      ...
      facts: {
        response_v9_accepted: known,
        multi_window_summary_visible: known && view.window !== null,
        edge_uncertainty_summary_visible: known && view.edge !== null,
        edge_block_visible: known && view.edge !== null && view.edge.blocked,
  ...
  function verifyPortfolioRiskStratifiedMultiWindowEdgeUncertaintyConsumerFixtureV9(
    descriptor,
    response
  ) {
    if (!strictCanonical.verifySealedDocument(descriptor, "descriptor_hash")) return false;
    var expected =
      buildPortfolioRiskStratifiedMultiWindowEdgeUncertaintyConsumerFixtureV9(response);
  ...
  return Object.freeze({
    ...
    buildPortfolioRiskStratifiedMultiWindowEdgeUncertaintyConsumerFixtureV9:
      buildPortfolioRiskStratifiedMultiWindowEdgeUncertaintyConsumerFixtureV9,
    verifyPortfolioRiskStratifiedMultiWindowEdgeUncertaintyConsumerFixtureV9:
      verifyPortfolioRiskStratifiedMultiWindowEdgeUncertaintyConsumerFixtureV9,
  });
});
