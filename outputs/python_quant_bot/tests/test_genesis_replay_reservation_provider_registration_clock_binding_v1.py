...
from exchange_terminal.application import (
    genesis_replay_reservation_provider_registration_clock_binding_v1 as binding,
)
from exchange_terminal.application import (
...
class GenesisReplayReservationProviderRegistrationClockBindingV1Tests(
    unittest.TestCase
):
    def setUp(self) -> None:
    ...
    def evaluate(self, **overrides):
        ...
        return binding.evaluate_genesis_replay_reservation_provider_registration_clock_binding_v1(
            **kwargs
        )
    ...
    def test_public_verifier_rebuilds_and_rejects_mutation(self) -> None:
        ...
        self.assertTrue(
            binding.verify_genesis_replay_reservation_provider_registration_clock_binding_v1(
                evidence,
                *args,
