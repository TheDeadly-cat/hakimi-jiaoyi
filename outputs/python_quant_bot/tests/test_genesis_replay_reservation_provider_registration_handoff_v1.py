...
from exchange_terminal.application import (
    genesis_replay_reservation_provider_registration_handoff_v1 as handoff,
)
from exchange_terminal.application import (
    challenge_consumption_provider_genesis_replay_reservation_preregistration_v1 as preregistration,
)
from exchange_terminal.application import (
    genesis_replay_reservation_provider_registration_challenge_signed_source_v1 as challenge,
)
from exchange_terminal.application import (
...
class GenesisReplayReservationProviderRegistrationHandoffV1Tests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.authority_preregistration = (
            challenge.build_genesis_replay_reservation_provider_registration_challenge_authority_preregistration_v1(
                **self.authority_kwargs
            )
        )
        ...
        self.challenge = (
            challenge.build_genesis_replay_reservation_provider_registration_challenge_v1(
                self.provider_preregistration,
                self.authority_preregistration,
                **self.challenge_build_kwargs,
            )
        ...
        self.signed_challenge = (
            challenge.build_signed_genesis_replay_reservation_provider_registration_challenge_v1(
                self.challenge,
                self.provider_preregistration,
                self.authority_preregistration,
        ...
        self.challenge_evidence = (
            challenge.evaluate_signed_genesis_replay_reservation_provider_registration_challenge_v1(
                self.signed_challenge,
                self.challenge,
                self.provider_preregistration,
                self.authority_preregistration,
    ...
    def _registration_bundle(
        ...
        evidence = (
            registration.evaluate_signed_genesis_replay_reservation_provider_registration_v1(
                signed,
                claim,
                self.provider_preregistration,
                **evaluation_kwargs,
    ...
    def evaluate_handoff(
        ...
        return handoff.evaluate_genesis_replay_reservation_provider_registration_handoff_v1(
            self.challenge_evidence
    ...
    def test_preregistration_and_challenge_are_exact_redacted_and_blocked(self) -> None:
        ...
        self.assertTrue(
            challenge.verify_genesis_replay_reservation_provider_registration_challenge_authority_preregistration_v1(
    ...
    def test_schema_extra_field_and_preregistration_drift_fail_closed(self) -> None:
        ...
        with self.assertRaises(
            challenge.GenesisReplayReservationProviderRegistrationChallengeSourceError
        ):
            challenge.build_genesis_replay_reservation_provider_registration_challenge_v1(
                drifted,
                self.authority_preregistration,
    ...
    def test_handoff_verifier_rebuilds_and_rejects_mutation(self) -> None:
        ...
        self.assertTrue(
            handoff.verify_genesis_replay_reservation_provider_registration_handoff_v1(
                evidence,
                *args,
