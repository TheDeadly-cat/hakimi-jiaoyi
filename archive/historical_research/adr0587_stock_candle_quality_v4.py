...
STOCK_CANDLE_QUALITY_CONTRACT_VERSION = "stock-candle-quality-v4"
...
def analyze_stock_candle_series(
    ...
    *,
    ...
    if not structure_complete or not temporal_complete or not clean_rows:
        status = "BLOCK"
